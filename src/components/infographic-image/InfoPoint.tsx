...
const InfoPoint = ({ point, setActivePoint, activePoint, width }: InfoPointProps) => {
  ...
  return (
    <div
      ...
      className={'zep-absolute zep-w-2.5 zep-h-2.5 md:zep-w-3 md:zep-h-3 zep-rounded-full zep-bg-typography-light-100'}
    >
      <div className="zep-hidden md:zep-block">
        <Tooltip color={'zps'} label={point.label} description={point.description}>
          <div className="zep-w-2.5 zep-h-2.5 md:zep-w-3 md:zep-h-3 zep-rounded-full zep-flex zep-justify-center zep-items-center zep-group">
            <div
              className={clsx(
                shadowCva({ variant: GlobalVariants.Zps }),
                'zep-flex zep-justify-center zep-items-center',
              )}
            >
      ...
      <div className="md:zep-hidden zep-w-2.5 zep-h-2.5 md:zep-w-3 md:zep-h-3 zep-rounded-full zep-flex zep-justify-center zep-items-center zep-group">
        <div
          className={clsx(shadowCva({ variant: GlobalVariants.Zps }), 'zep-flex zep-justify-center zep-items-center')}
        >
