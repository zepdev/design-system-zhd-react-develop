import{w as p,e as a,u as n}from"./index-0fccfe50.js";import{B as d,Z as v,z as m}from"./ZpsButton-55c033fb.js";import"./_commonjsHelpers-de833af9.js";import"./index-03bbf7d1.js";import"./_baseIsEqual-0d239887.js";import"./index-356e4a49.js";import"./jsx-dev-runtime-8ab8c10c.js";import"./index-b1e7e93e.js";import"./index.es13-373f5050.js";import"./jsx-runtime-6f6342d7.js";import"./index.es24-551679ca.js";import"./index.es35-79e31a69.js";import"./index.es31-95f1013f.js";import"./index-ff2c9236.js";import"./clsx-0839fdbe.js";import"./getUrlWithTrailingSlash-1f1feb13.js";import"./tw-merge-1166cefb.js";const k=Object.keys(m),z={title:"Components/ZpsButton",component:d,tags:["autodocs"],argTypes:{disabled:{control:{type:"boolean"}},isLoading:{control:{type:"boolean"}},variant:{control:{type:"select",options:k}}}},o={args:{variant:v.Primary,label:"Zps Button",title:"Button title",isLoading:!1,disabled:!1},play:async({canvasElement:s,step:e})=>{const t=p(s).getByRole("button");await e("Initial checks",async()=>{await a(t).toHaveTextContent("Button"),await a(t).toHaveAttribute("title","Button title"),await a(t).toBeEnabled()}),await e("Focus button with keyboard",async()=>{await n.tab(),await a(t).toHaveFocus()}),await e("Fire click event with keyboard",async()=>{await n.keyboard("{enter}"),await a(t).toHaveFocus(),await n.keyboard("{space}"),await a(t).toHaveFocus()}),await e("Fire click event with mouse",async()=>{await n.click(t),await a(t).toHaveFocus()}),await e("Blur button with keyboard and check focus",async()=>{await n.tab(),await a(t).not.toHaveFocus()})}},i={args:{variant:v.Primary,label:"",title:"Button title",icon:"alert",isLoading:!1,disabled:!1},play:async({canvasElement:s,step:e})=>{const t=p(s).getByRole("button");await e("Initial checks",async()=>{await a(t).toHaveAttribute("title","Button title"),await a(t).toBeEnabled()}),await e("Focus button with keyboard",async()=>{await n.tab(),await a(t).toHaveFocus()}),await e("Fire click event with keyboard",async()=>{await n.keyboard("{enter}"),await a(t).toHaveFocus(),await n.keyboard("{space}"),await a(t).toHaveFocus()}),await e("Fire click event with mouse",async()=>{await n.click(t),await a(t).toHaveFocus()}),await e("Blur button with keyboard and check focus",async()=>{await n.tab(),await a(t).not.toHaveFocus()})}};var c,r,u;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
...
}`,...(b=(l=i.parameters)==null?void 0:l.docs)==null?void 0:b.source}}};const D=["Default","IconButton"];export{o as Default,i as IconButton,D as __namedExportsOrder,z as default};
